...
async def add_tresormoney_document():
    ...
    # Trouver le fichier exact dans le dossier docs
    docs_dir = Path(__file__).parent.parent / "docs"
    target_filename = None
    
    # Utiliser directement le nom du fichier avec accent
    target_filename = "Foire aux questions sur TrésorMoney  v4.pdf"
    pdf_path = docs_dir / target_filename
