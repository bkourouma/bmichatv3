...
echo "🔧 Final fix for RetrievalService (corrected)..."

# 1. Créer une sauvegarde
cp app/services/retrieval_service.py app/services/retrieval_service.py.bak.final2
...
# 4. Vérifier la syntaxe avec python3
...
# 7. Vérifier les logs pour voir si le bypass est activé
echo "🔍 Checking backend logs for bypass messages..."
docker-compose logs --tail=20 backend | grep -A 5 -B 5 "BYPASS\|WARNING\|ERROR"
